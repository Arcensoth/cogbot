...
from cogbot.cogs.robo_mod.conditions.message_contains_any_of import (
    MessageContainsAnyOfCondition,
)
from cogbot.cogs.robo_mod.conditions.message_has_attachment import (
    MessageHasAttachmentCondition,
)
...
from cogbot.cogs.robo_mod.conditions.message_starts_with import (
    MessageStartsWithCondition,
)
